...
$(function () {
    $('.b-news').each(function () {
        ...
        $('.detail', news).on('click', function (e) {
            e.preventDefault();
            var parent = $(this).closest('.parent'),
                item = $(this).closest('.item');

            parent.find('.popup.popup-detail .text').text(item.find('.text').text());
            parent.find('.popup.popup-detail .date').text(item.find('.date').text());
            item.find('.img img').clone().appendTo(parent.find('.popup .img'));
            parent.find('.overlay').fadeIn(180);
            parent.find('.popup.popup-detail').fadeIn(180);

        });

        $('.close-popup', news).on('click', function (e) {
            e.preventDefault();
            news.find('.overlay').fadeOut(180);
            news.find('.popup').fadeOut(180);
        });

        $('.item', news).equalHeights();
    });
});
$(function () {
    $('.b-events').each(function () {
        ...
        $('.detail', events).on('click', function (e) {
            e.preventDefault();
            var parent = $(this).closest('.parent'),
                item = $(this).closest('.item');
        ...
        $('.close-popup', events).on('click', function (e) {
            e.preventDefault();
            events.find('.overlay').fadeOut(180);
            events.find('.popup').fadeOut(180);
        });

        $('.item', events).equalHeights();
...
$(function () {
    $('.b-site').each(function () {
        ...
        $('.close-popup', site).on('click', function (e) {
            e.preventDefault();
        ...
        if (str.indexOf('#login-exist') != -1) {
            site.find('.overlay').fadeIn(180);
            site.find('.popup.login-exist').fadeIn(180);
        }
    });
});
$(function () {
...
$(function () {
    $('.b-edit-profile').each(function () {
        var registration = $(this);

        $('.update-form', registration).validate({
            rules: {
                lastName: {
                    required: true
                },
...
$(function () {
    $('.b-admin').each(function () {
        var admin = $(this),
            arrows = {
                left: $('.left-arrow', admin),
                right: $('.right-arrow', admin)
            };

        var workerSwiper = new Swiper('.js-admin-slider', {
            speed: 400,
            loop: true,
            spaceBetween: 15,
            slidesPerView: 4,
        ...
        $('.detail', admin).on('click', function (e) {
            e.preventDefault();
            var parent = $(this).closest('.parent'),
                item = $(this).closest('.item');
        ...
        $('.profiles .fa-pencil-square-o', admin).on('click', function (e) {
            e.preventDefault();
            var parent = $(this).closest('.profiles'),
                item = $(this).closest('.item');


            admin.find('.overlay').fadeIn(180);
            parent.find('.popup').fadeIn(180);

            $('.set-login').val($('.get-login').val());
        });

        $('.news .fa-pencil-square-o', admin).on('click', function (e) {
            e.preventDefault();
            ...
            $('.set-id-news').val($(this).parent().parent().find('.get-id-news').val());
        });

        $('.events .fa-pencil-square-o', admin).on('click', function (e) {
            e.preventDefault();
            var parent = $(this).closest('.events'),
                item = $(this).closest('.item');

            admin.find('.overlay').fadeIn(180);
            parent.find('.popup').fadeIn(180);

            $('.set-id-events').val($(this).parent().parent().find('.get-id-events').val());
        });

        $('.close-popup, .overlay', admin).on('click', function (e) {
            e.preventDefault();
            admin.find('.overlay').fadeOut(180);
            admin.find('.popup').fadeOut(180);
            admin.find('.popup .img img').detach();
        });

        $('.add-record', admin).on('click', function (e) {
            e.preventDefault();
            var parent = $(this).closest('.parent');
            parent.find('.overlay').fadeIn(180);
            parent.find('.popup-add-record').fadeIn(180);
        });

        $(function () {
            $('.profiles').each(function () {
                var that = $(this);
                $('.item', that).equalHeights();
            });
        });
