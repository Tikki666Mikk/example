...
$(function () {
    $('.b-header').each(function () {
        ...
        $('.btn-sandwich', header).on('click', function (e) {
            e.preventDefault();

            $('.mobile-slide-menu', header).slideToggle(180);
        })
...
$(function () {
    $('.b-news').each(function () {
        ...
        var workerSwiper = new Swiper('.js-news-swiper', {
            speed: 400,
            loop: false,
            spaceBetween: 15,
            slidesPerView: 4,
...
$(function () {
    $('.b-events').each(function () {
        var events = $(this),
            arrows = {
                left: $('.left-arrow', events),
                right: $('.right-arrow', events)
            };

        var workerSwiper = new Swiper('.js-events-swiper', {
            speed: 400,
            loop: false,
            spaceBetween: 15,
            slidesPerView: 3,
...
$(function () {
    $('.b-registration').each(function () {
        var registration = $(this);

        $('.reg-form', registration).validate({
            rules: {
                login: {
                    required: true,
                    minlength: 6,
...
$(function () {
    $('.b-site').each(function () {
        var site = $(this),
            str = window.location.href;

        $('.close-popup', site).on('click', function() {
            site.find('.overlay').fadeOut(180);
            site.find('.popup').fadeOut(180);
        });

        if (str.indexOf('#success-registration') != -1) {
            site.find('.overlay').fadeIn(180);
            site.find('.popup.success-reg').fadeIn(180);
        }

        if (str.indexOf('#success-authorization') != -1) {
            site.find('.overlay').fadeIn(180);
            site.find('.popup.success-auth').fadeIn(180);
        }

        if (str.indexOf('#unsuccess-authorization') != -1) {
            site.find('.overlay').fadeIn(180);
            site.find('.popup.unsuccess-auth').fadeIn(180);
        }

        if (str.indexOf('#success-update') != -1) {
            site.find('.overlay').fadeIn(180);
            site.find('.popup.success-update').fadeIn(180);
        }

        if (str.indexOf('#success-logout') != -1) {
            site.find('.overlay').fadeIn(180);
            site.find('.popup.success-logout').fadeIn(180);
        }
    });
});